 ...
 * @author ivy tromata
 */
public class SemiPrivate extends javax.swing.JPanel {
    ...
    public void one() {
        try {
            String q = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "where Core1_bm_rooms.Room_type='SemiPrivate' and Core1_bm_roomroom.Roomlegitid='32005'";
    ...
    public void two() {
        try {
            String q = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "left join Core1_pr_PatientRegistration\n"
                    + "on Core1_bm_rooms.Patient_ID=Core1_pr_PatientRegistration.Patient_ID\n"
                    + "where Core1_bm_rooms.Room_type='SemiPrivate' and Core1_bm_roomroom.Roomlegitid='32006'";
    ...
    public void three() {
        try {
            String q = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "left join Core1_pr_PatientRegistration\n"
                    + "on Core1_bm_rooms.Patient_ID=Core1_pr_PatientRegistration.Patient_ID\n"
                    + "where Core1_bm_rooms.Room_type='SemiPrivate' and Core1_bm_roomroom.Roomlegitid='32007'";
    ...
    public void four() {
        try {
            String q = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "left join Core1_pr_PatientRegistration\n"
                    + "on Core1_bm_rooms.Patient_ID=Core1_pr_PatientRegistration.Patient_ID\n"
                    + "where Core1_bm_rooms.Room_type='SemiPrivate' and Core1_bm_roomroom.Roomlegitid='32008'";
    ...
    public void five() {
        try {
            String q = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "left join Core1_pr_PatientRegistration\n"
                    + "on Core1_bm_rooms.Patient_ID=Core1_pr_PatientRegistration.Patient_ID\n"
                    + "where Core1_bm_rooms.Room_type='SemiPrivate' and Core1_bm_roomroom.Roomlegitid='32009'";
    ...
    private void view() {
        ...
        try {
            ...
            String sql = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "left join Core1_pr_PatientRegistration\n"
                    + "on Core1_bm_rooms.Patient_ID=Core1_pr_PatientRegistration.Patient_ID\n"
                    + "where Core1_bm_rooms.Room_type='SemiPrivate'";
...
//}
    ...
    private void initComponents() {
        ...
        addpatient.add(imageHolder, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 40, 240, 190));
        ...
        addpatient.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 70, 30));
        ...
        jLabel7.setText("Patient Photo");
        addpatient.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 230, 240, 30));
        ...
        addpatient1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 40, 240, 190));
        ...
        addpatient1.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 110, 30));
        ...
        addpatient1.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 70, 30));
        ...
        rooms.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Room6", "Room7", "Room8", "Room9", "Room10" }));
        ...
        table.setToolTipText("Left Click to Add Patient in Bed and Room");
...
//               JOptionPane.showMessageDialog(null, "This bed is Occupied","Occupied",JOptionPane.ERROR_MESSAGE);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (h == 0) {
            try {
                ...
                String sql7 = "select * from Core1_pr_PatientRegistration where Patient_ID=? and PR_Status='New Patient'";
                ...
                if (rs.next()) {
                    try {
                        ...
                        String sql11 = "insert into Core1_ipd_admission(Patient_ID,Name,Dr_ID,Room_Type,Type,admitdate,status,idroom)values(?,?,?,?,?,?,?,?)";
                    ...
                    try {
                        ...
                        String sql11 = "insert into Core1_bm_roomshistory(Room_ID,Patient_ID,Doctor_ID,date_used,status)values(?,?,?,?,?)";
                    ...
                    try {
                        ...
                        String sql22 = "insert into Core1_PR_Overview(Patient_ID,name,gender,date_undergo,patient_type)values(?,?,?,?,?)";
                    ...
                    try {
                        ...
                        String sql = "update Core1_bm_rooms set date_occopied='" + value3 + "',bed_status='Occupied',bed_remarks='Inpatient',Patient_ID='" + value2 + "' where id='" + value1 + "'";
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                if (rs.next()) {
                    try {
                        String sql1 = "select\n"
                                + "Core1_bm_rooms.id as ROOMID,Core1_pr_PatientRegistration.image,\n"
                                ...
                                + "where Core1_pr_PatientRegistration.Patient_ID=? and Core1_bm_rooms.Room_type='SemiPrivate' and Core1_ipd_admission.status='Inpatient' and Core1_pr_PatientRegistration.PR_Status='Inpatient'";
                        pst = conn.prepareStatement(sql1);
                        pst.setString(1, search4.getText());
                        rs = pst.executeQuery();
                        if (rs.next()) {
