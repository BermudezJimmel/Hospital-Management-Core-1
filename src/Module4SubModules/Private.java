 ...
 * @author ivy tromata
 */
public class Private extends javax.swing.JPanel {
    ...
    public void one() {
        try {
            String q = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "where Core1_bm_rooms.Room_type='Private' and Core1_bm_roomroom.Roomlegitid='32010'";
    ...
    public void two() {
        try {
            String q = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "left join Core1_pr_PatientRegistration\n"
                    + "on Core1_bm_rooms.Patient_ID=Core1_pr_PatientRegistration.Patient_ID\n"
                    + "where Core1_bm_rooms.Room_type='Private' and Core1_bm_roomroom.Roomlegitid='32011'";
    ...
    public void three() {
        try {
            String q = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "left join Core1_pr_PatientRegistration\n"
                    + "on Core1_bm_rooms.Patient_ID=Core1_pr_PatientRegistration.Patient_ID\n"
                    + "where Core1_bm_rooms.Room_type='Private' and Core1_bm_roomroom.Roomlegitid='32012'";
    ...
    public void four() {
        try {
            String q = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "left join Core1_pr_PatientRegistration\n"
                    + "on Core1_bm_rooms.Patient_ID=Core1_pr_PatientRegistration.Patient_ID\n"
                    + "where Core1_bm_rooms.Room_type='Private' and Core1_bm_roomroom.Roomlegitid='32013'";
    ...
    public void five() {
        try {
            String q = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "left join Core1_pr_PatientRegistration\n"
                    + "on Core1_bm_rooms.Patient_ID=Core1_pr_PatientRegistration.Patient_ID\n"
                    + "where Core1_bm_rooms.Room_type='Private' and Core1_bm_roomroom.Roomlegitid='32014'";
    ...
    private void view() {
        ...
        try {
            ...
            String sql = "select Distinct Core1_bm_rooms.id as 'No.',Core1_bm_roomroom.RoomName as Room,Core1_bm_rooms.Bed_No as Bed,concat(Core1_pr_PatientRegistration.LastName,', ',Core1_pr_PatientRegistration.FirstName,' ',Core1_pr_PatientRegistration.MiddleName) as Name, Core1_bm_rooms.bed_status as Availability\n"
                    ...
                    + "left join Core1_pr_PatientRegistration\n"
                    + "on Core1_bm_rooms.Patient_ID=Core1_pr_PatientRegistration.Patient_ID\n"
                    + "where Core1_bm_rooms.Room_type='Private'";
...
//}
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Patient Photo");
        addpatient.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 230, 240, 30));
        ...
        rooms.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Room11", "Room12", "Room13", "Room14", "Room15" }));
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    try {
                        ...
                        String sql61 = "insert into Core1_bm_roomshistory(Room_ID,Patient_ID,Doctor_ID,date_used,status)values(?,?,?,?,?)";

                        pst = conn.prepareStatement(sql61);
                        pst.setString(1, bed.getText());
                    ...
                    try {
                        ...
                        String sql21 = "insert into Core1_PR_Overview(Patient_ID,name,gender,date_undergo,patient_type)values(?,?,?,?,?)";
                    ...
                    try {
                        ...
                        String sql666 = "update Core1_bm_rooms set date_occopied='" + value3 + "',bed_status='Occupied',bed_remarks='Inpatient',Patient_ID='" + value2 + "' where id='" + value1 + "'";

                        pst = conn.prepareStatement(sql666);
                ...
                if (rs.next()) {
                    try {
                        String sql1 = "select\n"
                                ...
                                + "Core1_ipd_admission.Ipd_ID as IPDID,Core1_pr_PatientRegistration.image,\n"
                                ...
                                + "where Core1_pr_PatientRegistration.Patient_ID=? and Core1_bm_rooms.Room_type='Private' and Core1_ipd_admission.status='Inpatient' and Core1_pr_PatientRegistration.PR_Status='Inpatient'";
                        pst = conn.prepareStatement(sql1);
                        pst.setString(1, search4.getText());
                        rs = pst.executeQuery();
                        if (rs.next()) {
